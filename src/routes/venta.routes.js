...
router.post('/', async (req, res) => {
    ...
    const response = await data_base.query('INSERT INTO VENTA(id_cliente, cant_art_total, precio_total, fecha_venta) VALUES ($1, $2, $3);', [venta.id_cliente, venta.cant_art_total, venta.precio_total, venta.fecha_venta]);
